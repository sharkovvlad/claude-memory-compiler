...
- [[fx-policy-revshare]] — FX policy для RevShare/комиссий: snapshot курса на дату операции (Big-Tech consensus), EUR валюта учёта (юрлицо Испания), Stars net base / card+USDT full base, ECB daily reference rate, `fx_rates_daily` audit, daily cron `FxRateUpdateCron`. mig 492 (2026-06-08).
