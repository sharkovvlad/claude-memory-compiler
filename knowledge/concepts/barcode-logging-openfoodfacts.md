...
**Миграции (ИТОГ — 450/451 после двойной collision-renumber, см. ниже):**
- **mig 450** `barcode_cache_and_pending` — `CREATE TABLE IF NOT EXISTS barcode_cache`
...
- **mig 451** `barcode_reply_button_and_copy` — статус `waiting_barcode_portion`
...
моих 448→450/449→451 (`git mv` + sed внутр. рефов «Migration NNN»/«mig NNN»),
