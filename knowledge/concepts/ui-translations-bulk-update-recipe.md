...
- [[concepts/i18n-cldr-plural-runtime]] — для шаблонов «{N} <word>» (ru/uk/pl/ar/es/fr/it/pt): placeholder `{N_word}` + `services/i18n_plural.format_count(n, lang, forms)`. Mig 419 (`dunning_d3` × 8 langs, PR #277) — референс apply.
