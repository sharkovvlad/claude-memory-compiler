...
## 🟡 OPEN QUESTION — goal-aware protein? (2026-06-02, НЕПРОВЕРЕННАЯ ГИПОТЕЗА)

> ⚠️ Это **не подтверждённый дефект и не утверждённый план** — гипотеза, поднятая в сессии 2026-06-02 при owner-тесте 417002669, и осознанно переформулированная (изначально подана слишком категорично). Owner справедливо запросил научное обоснование — оно **НЕ однозначное**. Не двигаться, пока не закрыты пункты валидации ниже.
